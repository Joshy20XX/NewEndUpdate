...
package net.mcreator.newendupdate.world.dimension;
...
public class EndBiomeTestDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("new_end_update:end_biome_test"), customEffect));
		}
	}
}
